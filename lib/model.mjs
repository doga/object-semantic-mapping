...
class Model { 
   ...
   * @see {@link https://rdf.js.org/data-model-spec/#namednode-interface|NamedNode interface, RDF/JS: Data model specification}
   * @see {@link https://rdf.js.org/data-model-spec/#blanknode-interface|BlankNode interface, RDF/JS: Data model specification}
