// A class for representing language codes

class Language {
  /** 
   * Language desriptions.
   * @see {@link https://github.com/haliaeetus/iso-639/blob/master/data/iso_639-1.json|Github repo}
   **/
  static languages = {
    "aa": {
      "639-1": "aa",
  ...
  * @static
  * */
  static fromCode(langCode) {
    for (const code of Object.keys(Language.languages)) {
      if (!Language.languages.hasOwnProperty(code)) continue;
      if (langCode !== code) continue;
      const lang = Language.languages[langCode];
      return new Language(lang["639-1"], lang["639-2"], lang.family, lang.name, lang.nativeName, lang.wikiUrl);
    }
    return null;
  }
  ...
  /** 
  * @param {string} code639_1
  * @param {string} code639_2
  * @param {string} family
  * @param {string} name
  * @param {string} nativeName
  * @param {(string|URL)} wikiUrl
  * @throws {TypeError} if wikiUrl is malformed
  * */
  constructor(code639_1, code639_2, family, name, nativeName, wikiUrl) {
    if (!(wikiUrl instanceof URL)) wikiUrl = new URL(wikiUrl);
    this.#code639_1 = code639_1;
    this.#code639_2 = code639_2;
    this.#family = family;
    this.#name = name;
    this.#nativeName = nativeName;
    this.#wikiUrl = wikiUrl;
  }
  get code639_1() { return this.#code639_1; }
  get code639_2() { return this.#code639_2; }
  get family() { return this.#family; }
  get name() { return this.#name; }
  get nativeName() { return this.#nativeName; }
